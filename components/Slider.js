...
const SliderModel = ({ SliderImages, SliderContent }) => {
    ...
    function SampleNextArrow(props) {
        ...
        return (
            <NextArrow onClick={next}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    function PrevousArrow(props) {
        ...
        return (
            <PrevArrow onClick={prev}><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
