...
const Model = ({ data }) => {
    ...
    const variants = {
        ...
        visible: { opacity: 1, transition: { delay: .1 }, y: 0 }
    }
    useEffect(() => {
        ...
        const setY = () => {
            ...
            if (window.scrollY >= 133.3333282470703 && window.scrollY <= 1000) return setView(true)
    ...
    return (
        <ModelContainer>
            ...
            <InteriorImage>
                <img src="https://tesla-view.thron.com/api/xcontents/resources/delivery/getThumbnail/tesla/1370x770/482c7084-fb08-4f68-8cea-ac8ec2fac56c.jpg?v=19&dpr=200" alt="" />
                <motion.p
                    style={{ x: -90 }}
                    variants={variants}
                    animate={view ? "visible" : "hidden"}
                >All-New Interior</motion.p>
            </InteriorImage>
            <SliderModel SliderImages={data.SliderImages} SliderContent={data.sliderContent} />
            <ExtraFeatures ExtraFeatures={data.ExtraFeatures} view={view} />
            <SecondImageModel>
                <img src="https://tesla-cdn.thron.com/delivery/public/thumbnail/tesla/d4a3d44d-a5b6-47b1-87db-707cbe0dade1/bvlatuR/std/1370x770/ModelS_03?lcid=2b084dd2-ade1-49ec-a470-45363112146c&v=18" alt="" />
                <SecondMile>
